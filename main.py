...
fig.savefig("Output/grafica_ejemplo_barras.png", bbox_inches="tight")
plt.close(fig)
...
fig.savefig("Output/grafica_ejemplo_pastel.png", bbox_inches="tight")
plt.close(fig)
...
while contador <=5:
    ...
    fig.savefig(f"Output/grafica_{contador}_barras.png", bbox_inches="tight")
    plt.close(fig)
    ...
    fig.savefig(f"Output/grafica_{contador}_pastel.png", bbox_inches="tight")
    plt.close(fig)
    
    contador=contador+1
print("Gráficas de barra y pastel generadas y guardadas en la carpeta 'Output'.")
